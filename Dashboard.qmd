...
Este dashboard explora las estadísticas de la incidencia de la violencia de género a nivel mundial. Los datos utilizados en la presente presentación provienen de la [OCDE](https://stats.oecd.org/viewhtml.aspx?datasetcode=GIDDB2019&lang=en), el [World Bank](https://datos.bancomundial.org/indicador) y el [PNUD](https://hdr.undp.org/data-center/human-development-index#/indicies/HDI).
...
En esta sección del dashboard exploramos la evolución de la esperanza de vida para un país específico a lo largo de un periodo de tiempo predeterminado. Nota que el sidebar ha cambiado respecto a la página anterior.
